...
const calcularChurrasco = () => {
    ...
    document.getElementById("total-carne").innerHTML = `Carne: ${getValueMeasure(totalCarne, 1)}`
    document.getElementById("total-pessoas").innerHTML = `Pessoas: ${totalPessoas} pessoas`
    document.getElementById("total-acompanhamento").innerHTML = `Acompanhamento: ${getValueMeasure(totalAcompanhamento, 1)}`
    document.getElementById("total-bebidas-nao-alcoolicas").innerHTML = `Bebidas não alcoolicas: ${getValueMeasure(totalBebidasNaoAlcoolicas, 2)}`
    document.getElementById("total-bebidas-alcoolicas").innerHTML = `Bebidas alcoolicas: ${getValueMeasure(totalBebidasAlcoolicas, 2)}`
